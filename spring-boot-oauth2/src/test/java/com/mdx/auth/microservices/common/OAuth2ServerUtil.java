...
public class OAuth2ServerUtil implements RestTemplateHolder {

	private static Log logger = LogFactory.getLog(OAuth2ServerUtil.class);
	...
	public Statement apply(final Statement base, FrameworkMethod method, Object target) {
		...
		try {
			client.getForEntity(new UriTemplate(getUrl("/oauth-server/admin/info")).toString(), String.class);
			online = true;
